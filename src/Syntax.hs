...
The general idea is that miniDafny is a cut down version of the Dafny
...
data Expression =
  ...
  | Forall Name Expression Expression  -- forall binding[expr]
  deriving (Eq, Ord, Show)
...
Below are some test programs. These programs can also be
found in the corresponding files in the `dafny` folder.

-}

wSquareBad = Method "Square" [("x",TInt)] [("z",TInt)] [Requires (Predicate (Op2 (Var (Name "x")) Gt (Val (IntVal 0)))),Ensures (Predicate (Op2 (Var (Name "z")) Eq (Op2 (Var (Name "x")) Times (Var (Name "x")))))] (Block [Decl ("y",TInt) (Val (IntVal 0)),Empty,Assign (Name "z") (Val (IntVal 0)),Empty,While (Predicate (Op2 (Var (Name "y")) Le (Var (Name "x")))) (Op2 (Var (Name "y")) Lt (Var (Name "x"))) (Block [Assign (Name "z") (Op2 (Var (Name "z")) Plus (Var (Name "x"))),Empty,Assign (Name "y") (Op2 (Var (Name "y")) Plus (Val (IntVal 1))),Empty])])
